        ...
        <section id="forus" className="forus">
          <ul className="forus__container">
            <li className="forus__left-container">
              ...
              <div className="forus__left-item">
                <p>
                  Ячменный солод – основа приготовления большинства сортов пива
                  и сырья для дистиляции.
                </p>
              </div>
              ...
              <div className="forus__left-item">
                <p>
                  Пшеничный солод -используется для приготовления пшеничного
                  пива, а также в качестве добавки ко многим лёгким сортам пива
                  и дистиляционным заторам.
                </p>
              </div>
